<div class="new-year-container">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // --- Rocket Class (বিস্ফোরণের পয়েন্ট সিঙ্ক করা হয়েছে) ---
            class Rocket {
                ...
                update() {
                    ...
                    // বর্তমান পজিশন ক্যালকুলেট করছি
                    this.currentX = this.x + (this.targetX - this.x) * ease;
                    this.currentY = this.y + (this.targetY - this.y) * ease;

                    if (this.progress >= 1) {
                        // ঠিক এই বর্তমান পজিশন থেকেই কনফেটি বের হবে
                        explode(this.currentX, this.currentY);
                        return false; // রকেট শেষ
                    }
                    return true; // রকেট চলছে
                }
                draw() {
                    ctx.save();
            ...
            function launchRocket() {
                ...
                // উইজেটের সেন্টার পজিশন থেকে রকেট লঞ্চ হবে
                rockets.push(new Rocket(rect.left + rect.width/2, rect.top + rect.height/2));
            }
