...
<div class="container-fluid py-4">
	...
	<div class="row mb-4">
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-primary animate__animated animate__zoomIn wow-card" data-wow-delay="0.1s">
				<div class="card-body">
		...
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-success animate__animated animate__jackInTheBox wow-card" data-wow-delay="0.2s">
				<div class="card-body">
					<div class="d-flex align-items-center">
		...
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-info animate__animated animate__fadeInDownBig wow-card" data-wow-delay="0.3s">
				<div class="card-body">
					<div class="d-flex align-items-center">
		...
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-warning animate__animated animate__rotateIn wow-card" data-wow-delay="0.4s">
				<div class="card-body">
					<div class="d-flex align-items-center">
	...
	<div class="row mb-4">
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-secondary animate__animated animate__fadeInUp wow-card">
				<div class="card-body">
					<div class="d-flex align-items-center">
		...
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-dark animate__animated animate__flipInY wow-card text-white">
				<div class="card-body">
					<div class="d-flex align-items-center">
		...
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-light animate__animated animate__lightSpeedInLeft wow-card text-dark">
				<div class="card-body">
					<div class="d-flex align-items-center">
		...
		<div class="col-md-3">
			<div class="card dashboard-card bg-gradient-danger animate__animated animate__rollIn wow-card text-white">
				<div class="card-body">
					<div class="d-flex align-items-center">
	...
	<div class="row">
		<div class="col-md-6 mb-4">
			<div class="card dashboard-card bg-gradient-info animate__animated animate__fadeInLeftBig">
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center mb-3">
						<h5 class="card-title mb-0"><i class="fas fa-calendar-alt me-2"></i> Calendar</h5>
						<button id="add-event-btn" class="btn btn-sm btn-light">+ Add Event</button>
					</div>
					<div id="calendar"></div>
				</div>
			</div>
		...
		<div class="col-md-6 mb-4">
			<div class="card dashboard-card bg-gradient-dark animate__animated animate__fadeInRightBig text-center text-light">
				<div class="card-body">
					...
					<p class="small opacity-75">Timezone: <strong>{{ date_default_timezone_get() }}</strong></p>
				</div>
			</div>
		</div>
	</div>
...
@push('css')
	...
	<style>
		...
		.bg-gradient-dark    { background: linear-gradient(135deg, #23262b 0%, #121416 100%); color: #fff; }
	...
	<script>
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			const calendar = new FullCalendar.Calendar(calendarEl, {
				...
				eventResizableFromStart: true, // disable resizing from start
				eventDurationEditable: true,   // disable resizing/stretching events
