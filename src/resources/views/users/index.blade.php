                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($user->profile_image)
                                        <img loading="lazy" src="{{ route('profile_img.show', ($user->profile_image)) }}"
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex align-items-center gap-1">
                                        <a href="{{ route('admin.users.show', $user->id) }}" class="btn btn-sm me-1 btn-encodex-show" title="@lang("View")">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-sm me-1 btn-encodex-edit {{ $user->id === auth()->id() ? 'disabled-link' : '' }}" title="@lang("Edit")" >
