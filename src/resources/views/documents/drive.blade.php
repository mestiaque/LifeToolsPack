            ...
            <div id="driveFilesGrid" class="row mt-3 drive-files-grid">
                ...
                <div class="col-lg-3 col-md-4 col-6 mb-4 drive-file-col" data-drive-file="{{ Str::lower($doc->name) }}">
                    <div
                        ...
                        @if($fileExists) data-file-url="{{ route('admin.drive.preview', $doc->stored_name ?? $doc->name, false) }}" @endif
                    >
                        <div class="position-absolute top-0 end-0 mt-2 me-2">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.drive.download', $doc->stored_name ?? $doc->name) }}" class="dropdown-item">
                        ...
                        <div>
                            ...
                            @elseif(Str::startsWith($doc->mime_type, 'image'))
                                <img loading="lazy" src="{{ route('admin.drive.preview', $doc->stored_name ?? $doc->name) }}" class="drive-file-thumb mb-2 border" />
                        ...
                        {{-- @if($fileExists)
                            <div class="drive-file-actions mt-2">
                                <a href="{{ route('admin.drive.download', $doc->stored_name ?? $doc->name) }}" class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" title="Download"><i class="bi bi-download"></i></a>
                                @if(Str::startsWith($doc->mime_type, 'application/pdf'))
                                    <a href="{{ route('admin.drive.preview', $doc->stored_name ?? $doc->name, false) }}" target="_blank" class="btn btn-sm btn-outline-secondary" data-bs-toggle="tooltip" title="Preview PDF"><i class="bi bi-eye"></i></a>
                                @endif
                            </div>
                        @endif --}}
                    </div>
