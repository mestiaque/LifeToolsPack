...
<head>
  ...
  <title>M. Estiaque Ahmed Khan | Portfolio</title>
  <meta name="description" content="Portfolio of M. Estiaque Ahmed Khan">
  <meta name="keywords" content="Portfolio, Resume, M. Estiaque Ahmed Khan, Software Developer, Engineer">
  <meta name="csrf-token" content="{{ csrf_token() }}" />

  <!-- Favicons -->
  <link href="{{ asset('front/img/me-logo.png') }}" rel="icon">
...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="#job" class="nav-link scrollto"><i class="bx bx-briefcase"></i> <span>Experience</span></a></li>
        <li><a href="#projects" class="nav-link scrollto"><i class="bx bx-code-block"></i> <span>Projects</span></a></li>
        <li><a href="#resume" class="nav-link scrollto"><i class="bi bi-file-earmark-richtext"></i> <span>Qualifications</span></a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex flex-column justify-content-center" style="background:url('{{ asset('storage/images/banner_image/' . get_setting('banner_image')) }}') top right no-repeat; background-size:cover" >
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>M. Estiaque Ahmed Khan</h1>
      <p>I'm <span class="typed designation" data-typed-items="{{ get_setting('designation') ?? 'Engineer, Software Developer' }}"></span></p>
      <div class="social-links mt-3">
            <a href="{{ get_setting('facebook_link') }}" target="_blank" class="facebook" title="Facebook"><i class="bx bxl-facebook"></i></a>
            <a href="{{ get_setting('instagram_link') }}" target="_blank" class="instagram" title="Instagram"><i class="bx bxl-instagram"></i></a>
            <a href="{{ get_setting('twitter_link') }}" target="_blank" class="twitter" title="Twitter"><i class="bx bxl-twitter"></i></a>
            <a href="{{ get_setting('linkedin_link') }}" target="_blank" class="linkedin" title="LinkedIn"><i class="bx bxl-linkedin"></i></a>
      </div>
    </div>
  </section>
        ...
        <div class="about-card">
          ...
          <div class="row align-items-center">
            <div class="col-lg-4 text-center mb-3 mb-lg-0">
              <img loading="lazy" src="{{ asset('storage/images/profile_image/' . get_setting('profile_image')) }}" class="about-profile-img" alt="Profile Photo">
            </div>
            <div class="col-lg-8 pt-4 pt-lg-0 content">
              <div class="about-designation">{{ $settings->designation ?? 'Software Engineer' }}</div>
              <div class="row">
                <div class="col-md-6">
                  <ul class="about-info-list">
                    <li><i class="bi bi-calendar-event"></i> <strong>DoB:</strong> <span>15 December 1998</span></li>
                    <li><i class="bi bi-phone"></i> <strong>Phone:</strong> <span>{{get_setting('mobile') ?? '09696009656'}}</span></li>
                    <li><i class="bi bi-envelope"></i> <strong>Email:</strong> <span>{{ get_setting('email') ?? 'info@mestiaque.com' }}</span></li>
                    <li><i class="bi bi-geo-alt"></i> <strong>City:</strong> <span>Dhaka, Bangladesh</span></li>
                  </ul>
                </div>
                <div class="col-md-6">
                  @php
                  ...
                  <ul class="about-info-list">
                    ...
                    <li><i class="bi bi-mortarboard"></i> <strong>Degree:</strong> <span>Masters</span></li>
                    <li><i class="bi bi-flag"></i> <strong>Nationality:</strong> <span>Bangladeshi</span></li>
                    <li><i class="bi bi-heart"></i> <strong>Religion:</strong> <span>Islam</span></li>
                    <li><i class="bi bi-droplet"></i> <strong>Blood Group:</strong> <span class="text-danger">O+</span></li>
                  </ul>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-6 mb-4">
                <div class="project-card skill-card">
                  <h4 class="mb-3" style="color:#0091c7;font-weight:600;">Frontend Skills</h4>
              ...
              <div class="col-lg-6 mb-4">
                <div class="project-card skill-card">
                  <h4 class="mb-3" style="color:#0091c7;font-weight:600;">Backend & Others</h4>
        ...
        <div class="row">
          ...
          @if(count($jobs) % 2 != 0 && count($jobs) > 0)
            @for($i = 0; $i < count($jobs) - 1; $i++)
              <div class="col-lg-6 mb-4">
                <div class="project-card equal-card">
                  <h4>{{ $jobs[$i]['title'] }}</h4>
                  <h5>{{ $jobs[$i]['period'] }}</h5>
                  <p><em>{{ $jobs[$i]['company'] }}</em></p>
                  <ul>
            ...
            <div class="col-lg-6 mb-4 mx-auto">
              <div class="project-card equal-card">
                <h4>{{ $jobs[count($jobs) - 1]['title'] }}</h4>
                <h5>{{ $jobs[count($jobs) - 1]['period'] }}</h5>
                <p><em>{{ $jobs[count($jobs) - 1]['company'] }}</em></p>
                <ul>
    ...
    <section id="projects" class="projects section-bg">
      <div class="container" data-aos="fade-up">
        ...
        @php
          $projects = [
            // [
            //   'title' => 'ME Bank Portal',
            //   'desc' => 'Online banking system built with Laravel and Bootstrap. Features include secure authentication, transaction management, and user dashboards.',
            //   'link' => '#',
            //   'link_text' => 'View Live',
            //   'badges' => [
            ...
            <div class="col-md-6 d-flex justify-content-center">
              <div class="project-card w-100">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                  ...
                  <div>
                    <a href="{{ $projects[0]['link'] }}" target="_blank" class="btn btn-sm btn-primary">{{ $projects[0]['link_text'] }}</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="project-card">
                  ...
                  <div class="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <div>
                      <a href="{{ $project['link'] }}" target="_blank" class="btn btn-sm btn-primary">{{ $project['link_text'] }}</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="container py-2">
      <div class="row align-items-center">
        <div class="col-md-6 order-2 order-md-1">
          ...
          <div class="credits">
            Designed & Developed by <a href="https://mestiaque.com">M. Estiaque Ahmed Khan</a>
          </div>
        </div>
        <div class="col-md-6 text-center text-md-end mb-3 mb-md-0 order-1 order-md-2">
          <a href="{{ route('cv') }}" class="btn btn-primary" title="Resume Preview">
            <i class="bi bi-file-earmark-richtext me-2"></i>Resume
          </a>
