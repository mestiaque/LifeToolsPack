...
class UserController extends Controller
{
    ...
    public function index()
    {
        $users = User::with('roles')
            ->whereDoesntHave('roles', function ($query) {
                $query->where('slug', 'super_admin'); // super_admin role বাদ দিচ্ছে
            })
            ->latest()
            ->paginate(get_setting('pagination', 10));

        return view('em_core::users.index', compact('users'));
    }
    ...
    public function create()
    {
        $roles = Role::withCount('users')
                ...
                ->latest()
                ->get();
        return view('em_core::users.create', compact('roles'));
    }
    ...
    {
        $user->load('roles');
        return view('em_core::users.show', compact('user'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('em_core::users.edit', compact('user', 'roles', 'userRoles'));
    }
